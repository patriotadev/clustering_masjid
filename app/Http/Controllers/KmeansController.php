...
class KmeansController extends Controller
{
    public function clusterData(Request $request)
    {
        ...
        // Data Centroid 1
        $centroid1 = KmeansModel::where('id', $request->centroid1);
        ...
        KmeansModel::where('id', $request->centroid1)->update([
            'centroid' => true
        ]);

        // Data Centroid 2
        $centroid2 = KmeansModel::where('id', $request->centroid2);
        ...
        KmeansModel::where('id', $request->centroid2)->update([
            'centroid' => true
        ]);

        // Data Centroid 3
        $centroid3 = KmeansModel::where('id', $request->centroid3);
        ...
        KmeansModel::where('id', $request->centroid3)->update([
            'centroid' => true
        ]);

        // Data Centroid 4
        $centroid4 = KmeansModel::where('id', $request->centroid4);
        ...
        KmeansModel::where('id', $request->centroid4)->update([
            'centroid' => true
        ]);

        // Data Centroid 5
        $centroid5 = KmeansModel::where('id', $request->centroid5);
        ...
        KmeansModel::where('id', $request->centroid5)->update([
            'centroid' => true
        ]);
    ...
    public function initData2()
    {
        $dataCluster = KmeansModel::where('iteration', 1)->get();
        $centroid1 = KmeansModel::where('kelompok_data', 'C1')->where('iteration', 1);

        // Membuat data baru di Iterasi ke-2
        foreach ($dataCluster as $data) {
            KmeansModel::create([
    ...
    public function clusterData2()
    {
        $dataCluster = KmeansModel::where('iteration', 2)->get();
        ...
        $centroid2 = KmeansModel::where('kelompok_data', 'C2')->where('iteration', 1);
        ...
        $centroid3 = KmeansModel::where('kelompok_data', 'C3')->where('iteration', 1);
        ...
        $centroid4 = KmeansModel::where('kelompok_data', 'C4')->where('iteration', 1);
        ...
        $centroid5 = KmeansModel::where('kelompok_data', 'C5')->where('iteration', 1);
    ...
    public function getClusterGroup2()
    {
        $dataCluster = KmeansModel::where('iteration', 2)->get();
    ...
    public function clusterDataIteration(Request $request)
    {
        $iterationCount = $request->iterationCount;
        ...
        $centroid2 = KmeansModel::where('kelompok_data', 'C2')->where('iteration', $iterationCount - 1);
        $garis_lintang2 = $centroid2->sum('garis_lintang') / $centroid2->count();
        $garis_bujur2 = $centroid2->sum('garis_bujur') / $centroid2->count();
        $jalan_besar2 = $centroid2->sum('jalan_besar') / $centroid2->count();
        $gang_sempit2 = $centroid2->sum('gang_sempit') / $centroid2->count();
        ...
        $centroid3 = KmeansModel::where('kelompok_data', 'C3')->where('iteration', $iterationCount - 1);
        $garis_lintang3 = $centroid3->sum('garis_lintang') / $centroid3->count();
        $garis_bujur3 = $centroid3->sum('garis_bujur') / $centroid3->count();
        $jalan_besar3 = $centroid3->sum('jalan_besar') / $centroid3->count();
        $gang_sempit3 = $centroid3->sum('gang_sempit') / $centroid3->count();
        ...
        $centroid4 = KmeansModel::where('kelompok_data', 'C4')->where('iteration', $iterationCount - 1);
        $garis_lintang4 = $centroid4->sum('garis_lintang') / $centroid4->count();
        $garis_bujur4 = $centroid4->sum('garis_bujur') / $centroid4->count();
        $jalan_besar4 = $centroid4->sum('jalan_besar') / $centroid4->count();
        $gang_sempit4 = $centroid4->sum('gang_sempit') / $centroid4->count();
        ...
        $centroid5 = KmeansModel::where('kelompok_data', 'C5')->where('iteration', $iterationCount - 1);
        $garis_lintang5 = $centroid5->sum('garis_lintang') / $centroid5->count();
        $garis_bujur5 = $centroid5->sum('garis_bujur') / $centroid5->count();
        $jalan_besar5 = $centroid5->sum('jalan_besar') / $centroid5->count();
        $gang_sempit5 = $centroid5->sum('gang_sempit') / $centroid5->count();
    ...
    public function getClusterGroupIteration(Request $request)
    {
        $iterationCount = $request->iterationCount;
        $dataCluster = KmeansModel::where('iteration', $iterationCount)->get();
